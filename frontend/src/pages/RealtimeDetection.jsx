    ...
    return new Promise((resolve, reject) => {
      ...
      videoRef.current.oncanplay = async () => {
        ...
        try {
          ...
          // Force video visibility and properties
          if (videoRef.current) {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-lg shadow-lg p-6">
            ...
            <div className="relative bg-gray-100 rounded-lg p-4">
              <div className="text-center mb-2">
                ...
                {stream && (
                  <div className="text-xs text-green-600 mt-1">
                    ✅ Stream Active | Ready: {videoRef.current?.readyState || 0} | Size: {videoRef.current?.videoWidth || 0}x{videoRef.current?.videoHeight || 0}
                    <button 
                      ...
                      onClick={() => {
                        if (videoRef.current) {
                          console.log("🔍 Debug video element:", {
                            srcObject: !!videoRef.current.srcObject,
                            tracks: videoRef.current.srcObject ? videoRef.current.srcObject.getTracks().length : 0,
                            paused: videoRef.current.paused,
                            muted: videoRef.current.muted,
                            autoplay: videoRef.current.autoplay,
                            style: videoRef.current.style.cssText,
                            computed: window.getComputedStyle(videoRef.current).getPropertyValue('display')
                          });
                        }
                      }}
                    >
              ...
              />
              {!stream && (
                <div className="absolute inset-4 flex items-center justify-center bg-gray-100 rounded-lg" style={{ zIndex: 2 }}>
